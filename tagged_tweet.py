...
from twitter import follow, OAuth, Twitter
import random
...
users = f = follow.follow(t, 'GreatIdeasDaily')

user = random.choice(follow.lookup_portion(t, users).values())

tweet = '@%s - %s' % (user, thought)
